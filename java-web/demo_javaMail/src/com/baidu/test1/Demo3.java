...
public class Demo3 {
	...
	public static void main(String[] args) throws Exception{
		...
		msg.setFrom(new InternetAddress("\"" + MimeUtility.encodeText("传智播客") 
				+ "\" <itcast_test@sina.com>"));
		...
		msg.setRecipients(RecipientType.TO,InternetAddress.parse(MimeUtility.encodeText("黎活明") 
				+ " <llm@itcast.cn>," + MimeUtility.encodeText("张孝祥") + " <zxx@itcast.cn>"));
		...
		attch1.setFileName(
				MimeUtility.encodeText("java培训.txt") //处理中文附件乱码问题
				);
