...
<html>
  <head>
    ...
    <title>My JSP 'newsinfoshow.jsp' starting page</title>
  ...
  <body>
  	<form style="margin-left:280px;" action="newsinfo?method=query" method="post" id="f1">
  		<input type="hidden" id="page" name="page" value="1">
  		<input type="hidden" id="pageSize" name="pageSize" value="2">
  		
  		按标题：<input type="text" style="width:78px" name="newstitle" value="${n.newsTitle}">&nbsp;&nbsp;&nbsp;&nbsp;				
  		按作者：<input type="text" style="width:78px" size="3" name="newsauthor" value="${n.newsAuthor}">&nbsp;&nbsp;&nbsp;&nbsp;
  		按内容：<input type="text" style="width:78px" size="3" name="newscontent" value="${n.newsContent}">
  		<input type="submit" value="检索">	
  	</form>
  	<form action="newsinfo?method=drop"  method="post" id="f2">
     <table align="center" border="1" cellspacing="0" width="60%">
		<tr>
			...
			<th>创建时间</th>
			<th>更新时间</th>
			<th>操作 [<a href="newsinfo?method=toSave" target="mainPage">添加</a>]</th>
		</tr>
		...
		<tr align="center">
			...
			<td>${news.createDatetime}</td>
			<td>${news.updateDatetime}</td>
			<td>	
				<a href="newsinfo?method=drop&ids=${news.id}" target="mainPage">删除</a>
				<a href="newsinfo?method=queryOne&id=${news.id}" target="mainPage">修改</a>
			</td>
		</tr>
		</c:forEach>
    </table>
