...
<html>
  <head>
    ...
    <title>My JSP 'rolesave.jsp' starting page</title>
  ...
  <body>
  <center>
  <form action="role?method=add" method="post">
  	<table>
  		<tr>
  			<td>角色名称:</td>
  			<td>
  				<input type="text" name="rolename" id="rname" onfocus="clear1()">
  		...
  		<tr>
  			<td>角色描述:</td>
  			<td>
  				<textarea id="zwjs" rows="5" cols="12" name="roledesc" onkeypress="checkarea()" onfocus="clear2()"></textarea>
