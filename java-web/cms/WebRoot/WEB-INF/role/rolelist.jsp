...
<html>
  ...
  <body>
  	<center>
  	<form action="role?method=query" method="post" id="f1">
  		<input type="hidden" name="page" id="page" value="1">
  		<input type="hidden" name="pageSize" id="pageSize" value="2">
  	</form>
  	</center>
  	<form action="role?method=drop"  method="post" id="f2">
    <table align="center" border="1" cellspacing="0" width="60%">
		<tr>
			<th><input type="checkbox" id="selAll">序号</th>
			<th>角色名称</th>
			<th>角色描述</th>
			<th>操作 [<a href="role?method=toSave" target="mainPage">添加</a>]</th>
		</tr>
		...
		<tr align="center">
			...
			<td>${type.role_desc}</td>
			<td>
				<a href="role?method=drop&ids=${type.id}" target="mainPage">删除</a>
				<a href="role?method=queryOne&id=${type.id}" target="mainPage">修改</a>
			</td>
		</tr>
		</c:forEach>
    </table>
