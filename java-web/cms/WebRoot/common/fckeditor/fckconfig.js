...
//default 第二行删掉倒数第二个参数。'SelectAll',
...
FCKConfig.ToolbarSets["Revert"] = [
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','TextColor','BGColor','Image','Flash','Table','Rule','Smiley','Preview'],
	'/',
	['Style','FontFormat','FontName','FontSize']
] ;

FCKConfig.ToolbarSets["lianze"] = [
 ['Bold','-','Style','Smiley'],
 '/',
 ['FontFormat']
] ; 
...
//FCKConfig.SmileyWindowWidth		= 665 ;
