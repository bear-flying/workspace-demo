...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=request.getContextPath() %>/style/images/title_arrow.gif"/> 岗位设置
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="role_modify.action">
        <div class="ItemBlock_Title1"><!-- 信息说明<DIV CLASS="ItemBlock_Title1">
        	<IMG BORDER="0" WIDTH="4" HEIGHT="7" SRC="<%=request.getContextPath() %>/style/blue/images/item_point.gif" /> 岗位信息 </DIV>  -->
        </div>
