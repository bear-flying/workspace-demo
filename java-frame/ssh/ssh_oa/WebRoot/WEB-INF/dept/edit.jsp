  ...
  <body>
	...
	<div class="easyui-layout" data-options="fit:true">   
           ...
           <div data-options="region:'center'">    		
              <form action="" id="ff">
            	部门名称：<input class="easyui-textbox" name="dept.deptName" style="width:200px"> <br><br>
<%--            部门编号：<input class="easyui-textbox" id="deptid" style="width:200px"> <br><br>--%>
  ...
  <script type="text/javascript">
	...
	function add(){
		$.post("dept!add.action",$("#ff").serialize(),function(msg){
			window.location.href="dept!listPage.action";
		});
	}
	</script>
</html>
