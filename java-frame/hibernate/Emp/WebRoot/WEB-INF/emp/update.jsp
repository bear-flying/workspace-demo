...
<html>
  ...
  <body>
    <s:form action="emp!modify.action">
    	姓名：<s:textfield name="emp.name"></s:textfield><br><br>
    	生日：<xv:datetimepicker name="emp.hiredate" displayFormat="yyyy-MM-dd"></xv:datetimepicker><br><br>
